...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/swint_convnextt_opt_weight_e3/swint_convnextt_opt.log"
...
output_dir = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/swint_convnextt_opt_weight_e3"  # CRF优化结果
...
alpha = 3  # 可根据实验调整，例如 1.5, 2.0, 3.0
