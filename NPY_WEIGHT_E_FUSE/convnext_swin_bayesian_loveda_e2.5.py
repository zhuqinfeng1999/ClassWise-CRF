...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/swint_convnextt_opt_weight_e2.5/swint_convnextt_opt.log"
...
output_dir = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/swint_convnextt_opt_weight_e2.5"  # CRF优化结果
