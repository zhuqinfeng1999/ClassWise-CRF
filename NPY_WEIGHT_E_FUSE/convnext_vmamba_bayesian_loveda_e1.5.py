...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/vmambat_convnextt_opt_weight_e1.5/vmambat_convnextt_opt.log"
...
# 2. 路径配置
net1_dir = r"/ZQFSSD/crf/DATA/loveda/convnexttpre_npy"  # 网络1预测结果 (.npy)
net2_dir = r"/ZQFSSD/crf/DATA/loveda/vmambatpre_npy"  # 网络2预测结果 (.npy)
images_dir = r"/ZQFSSD/crf/DATA/loveda/ori"      # 原始图像
gt_dir = r"/ZQFSSD/crf/DATA/loveda/lovedagt"     # 地面真相
output_dir = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/vmambat_convnextt_opt_weight_e1.5"  # CRF优化结果
...
iou_net1 = np.array([55.58, 66.08, 56.32, 68.61, 32.82, 42.33, 55.88])
iou_net2 = np.array([55.29, 65.08, 56.89, 71.31, 33.68, 40.17, 53.52])
