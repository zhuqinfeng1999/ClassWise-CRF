...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/vmambat_convnextt_opt_weight_e2.5/vmambat_convnextt_opt.log"
...
net2_dir = r"/ZQFSSD/crf/DATA/vaihingen/vmambatpre_npy"  # 网络2预测结果 (.npy)
images_dir = r"/ZQFSSD/crf/DATA/vaihingen/ori"      # 原始图像
gt_dir = r"/ZQFSSD/crf/DATA/vaihingen/vaihingengt"     # 地面真相
output_dir = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/vmambat_convnextt_opt_weight_e2.5"  # CRF优化结果
...
iou_net1 = np.array([83.35, 90.65, 68.75, 82.63, 72.57, 49.68])
iou_net2 = np.array([83.39, 91.11, 68.91, 83.04, 70.46, 49.51])
