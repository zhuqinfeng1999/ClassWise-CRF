...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/swint_vmambat_opt_weight_e/swint_vmambat_opt2.5.log"
...
output_dir = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/swint_vmambat_opt_weight_e2.5"  # CRF优化结果
