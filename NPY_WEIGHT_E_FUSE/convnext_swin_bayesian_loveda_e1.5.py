...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/swint_convnextt_opt_weight_e1.5/swint_convnextt_opt.log"
...
output_dir = r"/ZQFSSD/crf/OUTPUT/LOVEDA/NPY/swint_convnextt_opt_weight_e1.5"  # CRF优化结果
...
iou_net2 = np.array([54.61, 65.37, 55.98, 69.79, 31.69, 44.14, 52.19])  # Swin-T
