...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/swint_vmambat_opt_weight_e1.5/swint_vmambat_opt.log"
...
# 2. 路径配置
# 2. 路径配置
net1_dir = r"/ZQFSSD/crf/DATA/vaihingen/vmambatpre_npy"  # 网络1预测结果 (.npy)
...
output_dir = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/swint_vmambat_opt_weight_e1.5"  # CRF优化结果
...
iou_net1 = np.array([83.39, 91.11, 68.91, 83.04, 70.46, 49.51])
iou_net2 = np.array([84.00, 91.16, 68.55, 82.67, 72.03, 50.36])
