...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/swint_vmambat_opt_weight_e3/swint_vmambat_opt.log"
...
output_dir = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/swint_vmambat_opt_weight_e3"  # CRF优化结果
