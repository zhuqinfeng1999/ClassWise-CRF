...
# 配置日志记录
log_file_path = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/vmambat_convnextt_opt_weight_e3/vmambat_convnextt_opt.log"
...
output_dir = r"/ZQFSSD/crf/OUTPUT/vaihingen/NPY/vmambat_convnextt_opt_weight_e3"  # CRF优化结果
